...
class Applications(models.Model):
    ...
    responsible_dept = models.ForeignKey(
        Department, on_delete=models.CASCADE, db_column="responsible_dept_id"
    )
...
class Request(models.Model):
    ...
    request_type = models.CharField(
        max_length=50, choices=REQUEST_TYPE_CHOICES, default="Application"
    )
    complain_department_head = models.ForeignKey(
        Users,
        on_delete=models.CASCADE,
        null=True,
        blank=True,
    ...
    applicant = models.ForeignKey(
        Users, on_delete=models.CASCADE, db_column="applicant_id", blank=True, null=True
    )
    ...
    renderedtemplate = models.CharField(
