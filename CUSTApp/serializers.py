...
class RequestSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'comments', 'payment_status', 'payment_date', 'EmployeeID', 'StudentID','student_name', 'renderedtemplate','responsible_dept_id','responsible_dept_name','responsible_employee_name','request_file', 
        ]
